...
safety: ""               # 安全敏感 → auth|payment|crypto|delete|permission（由 check_constitution.py 自动标记）
---
...
- [ ] `[auto]` AC1: <可量化验收条件>
- [ ] `[human-verify]` AC2: <可量化验收条件>
- [ ] `[decision]` AC3: <需要人决策的条件>
...
## Ticket 质量自检（对照宪法 16 项 + 1 安全项）

- [ ] 1. estimate ≤1d
- [ ] 2. type 正确（AFK/HITL）
- [ ] 3. AC 可测量（标注 [auto]/[human-verify]/[decision]）
- [ ] 4. 代码目录已指定
- [ ] 5. 前置准备完整
- [ ] 6. mock/E2E 策略明确
- [ ] 7. SDK 用法可参考
